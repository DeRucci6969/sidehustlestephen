...
PACKS: list[Pack] = [
    Pack(
        ...
        [
            ...
            Asset("asset-cafe-pricing", "Menu Refresh Pricing Sheet", "XLSX", "Starter, full-refresh, and retainer pricing with a delivery-time and private-floor quote check."),
    ...
    Pack(
        ...
        "Garage Shelf Installation",
        "Turn a cluttered garage into an organised wall of storage in one afternoon.",
        "Local Service",
        "Homeowners, renters, landlords, and property managers",
        "$101-$500",
        "1-7 days",
        "Medium",
        "A simple install service that mounts manufactured shelving, overhead racks, and hooks to clear a garage floor, with fast before-and-after proof that sells the next job.",
        "Almost every garage is cluttered, the fix is highly visible, and a few hundred dollars of tools lets you deliver a result owners happily pay for and neighbours instantly want.",
        ["Buy a drill, stud finder and level", "Organise one garage for proof", "Pitch the street with the before-and-after"],
        "You install manufactured shelving and racks, not structural or load-bearing modifications. Locate wiring and pipes before drilling and respect product weight ratings.",
        [
            Asset("asset-garage-outreach", "Garage Outreach Scripts", "DOCX", "Door-hanger, neighbour note, DM, email, call, and follow-up scripts built around the before-and-after garage transformation."),
            Asset("asset-garage-pricing", "Garage Install Quote Calculator", "XLSX", "Single-bay, double, and premium install tiers with add-ons, materials, travel, quote builder, profit check, and recurring-organising options."),
            Asset("asset-garage-install", "Install & Safety Checklist", "PDF", "Pre-install checklist for wall type, locating wiring/pipes, anchor selection, load ratings, level mounting, before/after photos, and clean scope boundaries."),
            Asset("asset-garage-prompts", "AI Prompt Pack", "DOCX", "Practical prompts for photo-based quotes, wall-layout suggestions, anchor/load notes, local-group posts, and referral follow-ups."),
    ...
    Pack(
        ...
        "Mobile Headlight Restoration",
        "Cloudy headlights are a small fix with obvious before-and-after proof.",
        "Local Service",
        "Car owners, used-car sellers, landlords with fleets, and local dealers",
        "$51-$150",
        "1-7 days",
        "Easy",
        "A mobile car-care service that restores cloudy plastic headlights using a fixed process, clear scope boundaries, and strong before-and-after photos.",
        "The problem is visible in daylight, the result is easy to show, and many owners want the car to look cleaner before selling, inspecting, or driving at night.",
        ["Buy a starter restoration kit", "Restore one permissioned car for proof", "Pitch owners with cloudy headlights"],
        "Do not promise like-new results, roadworthiness, legal compliance, or permanent restoration. Some lenses need replacement.",
        [
            ...
            Asset("asset-headlight-aftercare", "Customer Aftercare Card", "DOCX", "Copyable customer handoff card for the applied product, cure restrictions, first safe wash, cleaning limits, result notes, and contact route."),
            ...
            Asset("asset-headlight-email-templates", "Client Email Templates", "DOCX", "Emails for sample-led outreach, quote requests, booking confirmation, pre-job prep, completion handoff, referral asks, and dealer batch follow-ups."),
            Asset("asset-headlight-faqs", "Client FAQs", "DOCX", "Buyer-facing FAQs for what restoration can and cannot fix, sealant, weather, timing, price, safety, and when replacement is better."),
            Asset("asset-headlight-proof", "Before & After Proof Kit", "DOCX", "Photo playbook for matched headlight shots, consent wording, file naming, marketplace captions, and referral follow-ups."),
        ],
    ),
    Pack(
        "gym-churn-report",
        ...
        ["Find 10 retention-active studios", "Send a dummy churn snapshot", "Pitch an anonymized one-month review"],
        ...
        [
            ...
            Asset("asset-gym-outreach", "Gym Owner Outreach Scripts", "DOCX", "Email, DM, call, and follow-up scripts built around public retention clues and anonymized-data starter offers."),
            Asset("asset-gym-pricing", "Churn Report Pricing Calculator", "XLSX", "Snapshot, sprint, and monthly report pricing with quote builder, data-scope guardrails, and profit check."),
    ...
    Pack(
        ...
        [
            ...
            Asset("asset-shopify-pricing", "Cart Audit Pricing Calculator", "XLSX", "Starter audit, full audit, implementation, and monthly cleanup pricing with quote builder and profit check."),
...
ASSET_POLISH_SECTIONS: dict[str, list[tuple[str, list[str]]]] = {
    ...
    "asset-gym-outreach": [
        ("Best prospect signals", [
            "Studio posts intro offers, class-pack discounts, member challenges, timetable changes, or win-back messaging.",
            "Reviews mention cancellation, scheduling, onboarding, injuries, crowding, price, or lack of progress.",
            "The studio is owner-operated or boutique enough that a manager can approve a manual one-month report.",
            "Avoid large chains first because access, procurement, and privacy approvals slow down a simple starter offer.",
        ]),
        ("Privacy-safe opener", [
            "Lead with a public retention clue and a dummy report snapshot, not a request for member data.",
            "Offer to work from anonymized cancellation reasons or a small exported list after the owner approves the scope.",
            "Say clearly that the report creates retention actions and decision structure, not guaranteed cancellation reduction.",
        ]),
    ],
    "asset-gym-call": [
    ...
    "asset-gym-pricing": [
        ("Pricing calibration", [
            "Price the first snapshot around manual analysis time, privacy handling, and the owner review call, not spreadsheet complexity.",
            "Charge more when the studio has multiple membership types, messy exports, several locations, or wants staff scripts included.",
            "Keep anonymized-data starter work separate from ongoing reporting so the first job stays low-risk and quick to approve.",
            "Monthly pricing should include trend tracking, action follow-up, and a fixed review cadence, not unlimited retention consulting.",
        ]),
    ],
    "asset-shopify-audit": [
    ...
    "asset-shopify-pricing": [
        ("Pricing calibration", [
            "Separate audit, copywriting, and implementation so the first paid job does not turn into unpaid store management.",
            "Charge more when the store has many priority products, several email flows, unclear policies, multiple approval owners, or active campaigns.",
            "Keep every forecast out of the proposal. Sell clearer buyer decisions, not guaranteed conversion lift.",
            "Monthly cleanup works best for stores with regular launches, seasonal offers, ad traffic, or frequent product-page changes.",
        ]),
    ],
    "asset-ugc-brief": [
...
def script_sections(pack: Pack, asset: Asset) -> list[tuple[str, list[str]]]:
    base_offer = {
        ...
        "garage-shelf-installation": "a fixed-scope garage shelving install that clears the floor with mounted shelving, racks, and hooks, plus before/after proof",
        "mobile-headlight-restoration": "a mobile headlight restoration service with lens-condition checks, paint masking, sanding, polishing, UV sealant, and before/after proof",
        "gym-churn-report": "a one-month churn snapshot that turns anonymized cancellation reasons into reason tags, revenue-at-risk placeholders, and three owner-approved retention actions",
...
def checklist_sections(pack: Pack, asset: Asset) -> list[tuple[str, list[str]]]:
    tailored = {
        ...
        "asset-garage-install": [
            "Confirm garage size, wall material, ceiling height, what's being stored, and who supplies the shelving before accepting paid work.",
            "Scan every drill line for studs, electrical cables, and water/gas pipes; mark studs and no-drill zones before drilling.",
            "Match each fixing to the wall type (studs, masonry anchors, or rated toggles) and keep the load within the product's weight rating.",
            "Dry-lay the layout: walkways clear, heavy items low, daily items at reach, seasonal high, and overhead racks clear of the car and door.",
            "Take before/after photos from fixed angles, give the owner weight-limit guidance, and refer structural or load-bearing work to a qualified trade.",
        ],
        "asset-headlight-safety": [
            "Confirm the lens is plastic and restorable; reject cracked lenses, heavy internal moisture, severe crazing, broken tabs, or lights that clearly need replacement.",
            "Clean the lens, mask surrounding paint and trim, protect nearby panels, and keep sanding water and compound away from unprotected surfaces.",
            "Use the planned grit sequence, polish carefully, apply UV sealant or coating, and follow the product cure instructions before handing off.",
            "Wear eye protection, gloves, and a dust mask where needed; avoid windy, rainy, extreme-heat, or poor-light jobs that make quality control harder.",
            "Take before/after photos from the same angle and explain that restoration improves appearance and clarity but is not a roadworthy certificate or permanent fix.",
        ],
    }[asset.id]
...
SPECIAL_ASSET_SECTIONS: dict[str, list[tuple[str, list[str]]]] = {
    ...
    "asset-garage-install": checklist_sections(*find_pack_for_asset("asset-garage-install")) + [
        ("Go/no-go decision gate", [
            "Do not start if wall material, fixings, wiring/pipe locations, load needs, ceiling structure, or safe work area are unclear.",
            "Do not attempt structural changes, load-bearing modifications, or heavy ceiling-mounted racks unless qualified; refer those to a licensed builder or engineer.",
            "Do not drill before checking for electrical cables, water, and gas lines on both sides of the wall; use a detector and check near switches, outlets, and wet areas.",
            "Stop if you hit a service, the wall is unsuitable or damaged, or the load exceeds the product or fixing rating.",
        ]),
        ("Locate services before drilling", [
            "Scan each drill line with a stud + live-wire + metal/pipe detector and mark studs and no-drill zones.",
            "Assume cables run vertically and horizontally from outlets, switches, and the consumer board; avoid those paths.",
            "Check the opposite side of the wall for plumbing, gas, vents, or fixtures.",
            "When in doubt, move the fixing point or pause and ask the owner before drilling.",
        ]),
        ("Wall type + anchor selection", [
            "Plasterboard/drywall: fix into studs where possible; otherwise use rated toggle or heavy-duty anchors.",
            "Brick/block/concrete: use masonry anchors and a masonry bit; fix into the solid, not the mortar joints, where appropriate.",
            "Timber stud/sheet: drive into studs/noggins; pre-drill to avoid splitting.",
            "Match every fixing and the shelf/rack to the manufacturer weight rating; never exceed it.",
        ]),
        ("Layout + level", [
            "Dry-lay the plan: walkways clear, heavy items low, frequently used items at reach height, seasonal up high.",
            "Mark a level reference line; check level and spacing before final fixing.",
            "Leave clearance for the car, doors, the opener track, and any vents or panels.",
            "Confirm overhead racks clear vehicles and garage-door travel.",
        ]),
        ("Install + cleanup", [
            "Take wide before photos of each wall from the client-facing angle.",
    ...
    "asset-headlight-aftercare": [
        ("Purpose and when to use it", [
            "Complete this card after the final quality check and give it to the customer before leaving the vehicle.",
            "Use the current instructions for the exact product system applied. Do not use a universal cure, rain, touch, driving, or washing time.",
            "This card records cosmetic restoration aftercare. It does not certify roadworthiness, electrical performance, legal compliance, permanent results, or suitability for every lens.",
        ]),
        ("Operator completion fields", [
            "Customer: [full name]",
            "Vehicle: [year, make, model and registration only if required for the job record]",
            "Service date: [date]",
            "Finish time: [local time and time zone]",
            "Product system applied: [brand, product and relevant batch or expiry detail]",
            "Protection step: [exact product or process]",
            "Weather and cure conditions at handoff: [temperature, shade, rain risk or other relevant condition]",
            "Operator contact route: [phone, email or booking link]",
        ]),
        ("Copyable customer aftercare card", [
            "Your headlight restoration was completed at [time] on [date] using [product system]. The service covered cosmetic restoration of the two agreed exterior plastic lenses.",
            "Until [exact date and time], keep the lenses [dry / untouched / out of rain / otherwise protected] as required by the product instructions.",
            "Driving guidance for this product system: [write the verified instruction or state that no restriction was specified].",
            "First safe wash: [exact date and time]. Wash method: [verified gentle cleaning method].",
            "Avoid: [automatic wash, pressure washing, abrasives, solvents, compounds, tape, covers or other product-specific restrictions].",
            "What improved: [plain result notes]. Remaining limits: [haze, crazing, scratches, internal moisture, damage or none observed].",
            "This was a cosmetic restoration. It was not a roadworthiness, beam-performance, electrical, legal-compliance, or permanent-result assessment.",
            "If the finish is touched, wet, marked, or exposed before the stated cure point, contact [operator] before applying another product or attempting a repair.",
        ]),
        ("Weather interruption message", [
            "Hi [customer], the applied [product] needs [verified cure condition] until [exact date and time]. [Rain / moisture / dust / contact] occurred before that point.",
            "Please do not wipe, wash, polish, sand, coat, or cover the lenses yet. Send clear daylight photos from the front and both angles to [contact route].",
            "I will compare the photos with the product instructions and confirm whether the finish can be left, needs an in-person check, or should be referred. I will not guess from one unclear photo.",
        ]),
        ("Customer handoff checklist", [
            "[ ] Product name and application time are written on the card.",
            "[ ] Cure, rain, touch, driving, and washing instructions match the current product guidance.",
            "[ ] The customer knows the first safe wash time and approved cleaning method.",
            "[ ] Remaining lens limits and any replacement or professional-assessment recommendation are recorded.",
            "[ ] Matched before-and-after photos have been sent.",
            "[ ] The customer has a contact route for a disturbed finish or aftercare question.",
            "[ ] Public use of photos has separate written permission.",
        ]),
        ("Customisation notes", [
            "Delete any restriction that does not apply to the exact system. Never leave two conflicting options on the customer version.",
            "Use an exact date and local time instead of phrases such as tomorrow, later, or after a while.",
            "Keep product instructions or a product data sheet with the job record so the advice can be traced later.",
            "Translate the card into plain customer language where useful, but do not change the product maker's meaning.",
        ]),
        ("Common mistakes", [
            "Giving every customer the same one-hour, one-day, or one-week rule without checking the applied system.",
            "Saying the headlights are permanent, like new, roadworthy, legally compliant, or guaranteed to improve night driving.",
            "Forgetting the product name, application time, weather conditions, remaining lens limits, or contact route.",
            "Telling the customer to fix an early water mark with polish, solvent, abrasive, or another coating before checking the product instructions.",
            "Treating permission to take handoff photos as permission to post the car, plate, driveway, name, or result publicly.",
        ]),
        ("Next action and related assets", [
            "Save one master card for each product system you genuinely use, then verify it whenever the manufacturer updates the instructions.",
            "Complete the On-Site Delivery SOP before this card, attach the matched photos from the Before & After Proof Kit, and save the final card with the intake form and job record.",
            "After the customer confirms the handoff, use the Client Email Templates for the follow-up and referral request.",
        ]),
    ],
    "asset-headlight-proof": [
        ("Before/after photo standard", [
            "Shoot both headlights before starting from the same angle, distance, and daylight direction you will use after completion.",
            "Take one wide front photo, one left headlight close-up, one right headlight close-up, and one angled photo that shows lens haze.",
            "Do not over-edit the after photos. Crop, straighten, and label only; the proof should be believable.",
            "Ask written permission before posting the car, plate, driveway, owner name, or dealer name.",
        ]),
        ("Proof captions", [
            "Private-owner caption: Cloudy plastic headlights cleaned up with sanding, polish, and UV sealant. Some lenses need replacement, but this one was a good restoration candidate.",
            "Used-car seller caption: Small presentation fix before listing photos. Cleaner lights, clearer look, no claims about roadworthiness or sale price.",
            "Dealer batch caption: Batch restoration morning for restorable lenses. Each car gets before/after photos and condition notes.",
        ]),
        ("Referral messages", [
            "Thanks again. If anyone in your street or family has cloudy plastic headlights, I can do the same fixed-price pair while I am nearby.",
            "I am booking two-car household slots this week. If you want the second car checked, send a photo of the lights first and I will tell you if it is restorable.",
            "For dealers: I can quote a batch rate if you have 3+ cars with restorable plastic headlights and a shaded work area.",
        ]),
        ("File naming", [
            "Format: client-car-headlight-before-left-date.jpg",
            "Format: client-car-headlight-after-left-date.jpg",
...
PROMPT_PACK_SECTIONS: dict[str, list[tuple[str, list[str]]]] = {
    ...
    "asset-headlight-prompts": [
        ("How to use these prompts", [
            "Use AI for lead scoring, outreach, quote notes, and handoff copy; do not use it to decide whether a lens is mechanically or legally safe.",
            "Paste real photo observations and mark unknowns. Do not guess lens material, internal moisture, cracks, roadworthiness, or permanent result.",
            "Keep every buyer-facing line honest: improvement, appearance, clarity, UV protection, aftercare, and replacement boundary.",
        ]),
        ("Photo-based lead scoring prompts", [
            "Review these headlight photos and prospect notes: [paste]. Return a table with Car, Visible haze level, Restoration candidate yes/no/maybe, Missing info, Risk, Suggested starter offer.",
            "Create a short lead note for this car listing: [paste listing/photos]. Focus on cloudy headlights and presentation before sale photos. Avoid claims about sale price, safety, or compliance.",
            "Write a no-go note for a lens that appears cracked, moisture-filled, deeply crazed, or not suitable for restoration. Keep it helpful and recommend replacement or a qualified mechanic where appropriate.",
        ]),
        ("Quote and scope prompts", [
            "Turn these client details into a conservative quote: [car make/model, lens photos, condition, location, travel, weather, workspace]. Include fixed pair price, travel, expected time, result boundary, and what is excluded.",
            "Create a pre-job question list for a headlight restoration lead. Separate must-have details from nice-to-have details.",
            "Write a text message confirming a mobile headlight restoration booking. Include arrival window, shaded workspace, weather caveat, water/power if needed, car access, payment, and aftercare.",
        ]),
        ("Outreach prompts", [
            "Write a neighbour note for a car with cloudy headlights. Mention the visible issue, fixed-price pair restoration, before/after proof, and honest boundary that some lenses need replacement.",
            "Write a marketplace message to a used-car seller whose listing photos show cloudy headlights. Frame it as presentation before listing photos or inspection, not guaranteed sale price.",
            "Write a short dealer outreach email offering a 3-car headlight restoration batch morning with before/after photo logs and per-car pricing.",
            "Create five follow-ups after sending a headlight before/after sample. Each should add one useful note: UV sealant, weather window, two-car bundle, dealer batch, or replacement boundary.",
        ]),
        ("Safety and expectation language prompts", [
            "Rewrite this client message so it explains restoration limits without sounding negative: [paste]. Include that results depend on lens condition and some headlights need replacement.",
            "Create an aftercare note for restored plastic headlights. Include curing time, washing, harsh chemicals, UV exposure, and when haze may return.",
            "Write a completion handoff where one lens improved less than the other because of deeper damage. Keep it professional and transparent.",
        ]),
        ("QA prompts", [
            "QA this headlight restoration quote before I send it: [paste]. Check for unsupported safety claims, legal compliance claims, permanent-result promises, missing weather/access details, missing exclusions, and unclear next step.",
            "Review this before/after caption: [paste]. Remove hype, exaggerated results, safety guarantees, and any claim that sounds like roadworthiness or certification.",
            "Create a final job log from these notes: [paste]. Include before photos, lens condition, process used, UV sealant, limitations, after photos, aftercare, and referral ask.",
        ]),
    ],
    "asset-drone-roof-prompts": [
        ("How to use these prompts", [
    ...
    "asset-garage-prompts": [
        ("How to use these prompts", [
            "Use AI for sales copy, quotes, layout ideas, and handoff notes; it is not a substitute for trade judgement, locating services, or product load ratings.",
            "Replace every bracketed field with real job details before sending anything to a client.",
            "Ask the model to flag unknowns instead of guessing wall type, fixings, wiring locations, or weight limits.",
            "Avoid promising structural changes, guaranteed load capacities, or work outside manufactured shelving and rack installation.",
            "Keep the offer narrow: clear the floor with manufactured shelving, racks, and hooks, with before/after proof.",
        ]),
        ("Photo-based quote prompts", [
            "Act as a practical garage shelving quote assistant. Review these photos and notes: [paste size, wall type, ceiling height, what to store, access]. Return a table with Wall, Suggested storage, Fixing type, Risk/uncertainty, Missing info, Recommended scope.",
            "Turn these job notes into a conservative labour + materials quote range: [paste]. Separate labour from materials, include travel/setup, and list what is excluded.",
            "Create a pre-quote question list for this garage lead: [paste notes]. Separate must-have answers (wall type, services, what to store) from nice-to-have details.",
        ]),
        ("Layout + safety language prompts", [
            "Suggest a practical storage layout for this garage: [size, ceiling height, what to store, car yes/no]. Keep walkways clear, heavy low, daily items at reach, seasonal high, and note where overhead racks suit.",
            "Write a client-safe note explaining that fixings and shelves are installed to the manufacturer weight rating and that heavy or structural loads are out of scope: [paste context].",
            "Write a plain-English exclusions list for a beginner garage install service: structural changes, load-bearing work, heavy ceiling loads, electrical, and plumbing are excluded unless done by a qualified pro.",
        ]),
        ("Outreach prompts", [
            "Write a short neighbour note offering to clear a cluttered garage with a clean wall of shelving in an afternoon. Mention a photo-based quote and before/after proof. Under 110 words.",
            "Write a local-group post built around a before/after garage transformation. Friendly, no hype, with a simple call to message for a quote.",
            "Create five follow-up messages after sending a garage before/after sample. Each adds one useful note: wall type, what to store, timing, materials, or a neighbour cluster discount.",
        ]),
        ("Delivery prompts", [
            "Create a pre-install checklist from these details: [client, address, wall type, what to store, access, services]. Return client prep, installer prep, service-location check, and completion photos.",
            "Write a booking confirmation email for a garage install. Include arrival window, cleared work area, parking, pets, who supplies materials, and payment terms.",
            "Write a completion handoff message with before/after photos, what was installed, weight-limit guidance, and a referral request.",
        ]),
        ("QA prompts", [
            "QA this quote before I send it: [paste]. Check for missing wall type, unlocated services, unsupported load promises, materials vs labour confusion, underpriced time, missing exclusions, and vague next steps.",
            "Review this client-facing garage page copy: [paste]. Remove hype, income claims, structural promises, and unsafe guarantees. Return safer practical wording.",
            "Create a final job log from these notes: [paste]. Include before photos, wall type, services located, fixings used, after photos, weight guidance given, and referral asked.",
        ]),
    ],
    "asset-gbp-prompts": [
        ("How to use these prompts", [
...
PACK_DELIVERABLES: dict[str, str] = {
    ...
    "garage-shelf-installation": "garage photos, approximate size, wall material, what needs storing, ceiling height, access constraints, budget, and client approval boundaries",
    "mobile-headlight-restoration": "car make/model, headlight photos, lens condition, location, workspace access, weather window, result expectations, and client approval boundaries",
...
def workbook_for(asset_id: str) -> dict[str, list[list[Any]]]:
    if asset_id == "asset-cafe-pricing":
        return {
            ...
            "Pricing Ladder": [
                ...
                ["Standard Refresh", "Print, QR menu, Google menu link, 3 social panels", 449, 175, "Most cafes"],
                ["Full Menu Refresh", "Bounded menu refresh, QR flow, specials template, launch posts", 699, 275, "Multi-location or high-change menus"],
                ["Monthly Specials", "Specials board, story graphic, menu link update", 0, 225, "Cafes that change offers weekly"],
                ["Multi-location Add-on", "Adapt the approved refresh across each extra location", 249, 150, "Small cafe groups"],
            ],
            "Quote Builder": [
                ["Input", "Value"],
                ["Base package price", 449],
                ["Estimated delivery hours", 6],
                ["Private hourly price floor", 60],
                ["Direct costs", 20],
                ["Risk buffer rate", 0.1],
                ["Rush fee", 0],
                ["Extra menu page count", 0],
                ["Price per extra page", 35],
                ["Extra social panels", 0],
                ["Price per social panel", 25],
                ["Scope-based quote subtotal", "=B2+B7+(B8*B9)+(B10*B11)"],
                ["Private minimum", "=(B3*B4)+B5"],
                ["Recommended quote", "=MAX(B12,B13)*(1+B6)"],
    ...
    if asset_id == "asset-garage-pricing":
        return {
            "Instructions": [
                ["Step", "What to do"],
                [1, "Choose an install tier based on garage size, wall type, what is being stored, and access."],
                [2, "Use Quote Builder for one job. Edit only the input values in column B. Labour is priced separately from materials."],
                [3, "Add Add-ons (overhead racks, pegboard, hooks, workbench) per item and confirm wall suitability first."],
                [4, "Use Job Profit Check to keep labour profitable; use Job Log to capture before/after proof and referrals."],
            ],
            "Pricing Ladder": [
                ["Tier", "Deliverables (labour)", "Price", "Best For", "Notes"],
                ["Sample Organise", "Tidy + mount one short shelf run, before/after photo", 0, "Proof for a neighbour or landlord", "Use selectively, not as free labour"],
                ["Single-Bay Install", "One wall of shelving in a single-car garage", 350, "Most homeowners", "Core offer"],
                ["Double-Garage Install", "Two walls of shelving + basic hooks", 550, "Family garages", "Confirm stud spacing and wall type"],
                ["Premium Storage Wall", "Shelving + overhead rack + pegboard + hooks", 850, "Full transformations", "Half to full day; confirm load ratings"],
                ["Per-Property Bundle", "Repeat install across rentals/new builds", "POA", "Landlords and builders", "Quote per unit, photo handoff included"],
            ],
            "Quote Builder": [
                ["Input", "Value"],
                ["Base install tier (labour)", 350],
                ["Travel/setup fee", 40],
                ["Extra shelf run", 1],
                ["Price per extra shelf run", 90],
                ["Overhead rack install", 150],
                ["Pegboard wall install", 120],
                ["Materials (shelving/anchors) at cost", 220],
                ["Materials handling markup %", 0.15],
                ["Estimated quote", "=B2+B3+(B4*B5)+B6+B7+B8*(1+B9)"],
                ["Deposit due at 30%", "=B10*0.3"],
            ],
            "Add-ons": [
                ["Add-on", "Typical Labour", "Wall Check Needed", "Notes"],
                ["Overhead/ceiling rack", 150, "Yes - ceiling joists + load rating", "Refer heavy/structural loads to a pro"],
                ["Pegboard / slatwall panel", 120, "Yes - anchor to studs", "Great for tool walls"],
                ["Bike + tool hooks", 60, "Yes - studs or rated anchors", "Quick high-impact add"],
                ["Workbench mount/assembly", 180, "Sometimes", "Assembly + secure to wall"],
                ["Haul-away of old shelving", 60, "No", "Confirm disposal rules locally"],
            ],
            "Job Profit Check": [
                ["Metric", "Illustrative Value", "Formula/Note"],
                ["Labour quote", "='Quote Builder'!B2", "Labour only, excludes materials"],
                ["Tool depreciation/consumables", 15, "Anchors, bits, blades per job"],
                ["Fuel/transport", 20, "Use actual"],
                ["Total hard cost", "=B3+B4", ""],
                ["Gross margin", "=B2-B5", ""],
                ["Job hours", 4, "Travel, layout, mounting, cleanup, handoff"],
                ["Hourly gross", "=IF(B7=0,\"\",B6/B7)", ""],
            ],
            "Client Inputs": [
                ["Input", "Owner", "Required?", "Status"],
                ["Garage photos (each wall + ceiling)", "Client", "Yes", "Open"],
                ["Approx size (single/double) + ceiling height", "Client", "Yes", "Open"],
                ["Wall material (plasterboard/brick/block/timber)", "Client", "Yes", "Open"],
                ["What needs storing (boxes, bikes, tools, sports)", "Client", "Yes", "Open"],
                ["Known wiring, pipes, or conduit in walls", "Client", "Yes", "Open"],
                ["Who supplies shelving/racks (you or client)", "Client", "Yes", "Open"],
                ["Access, parking, pets, and timing constraints", "Client", "No", "Open"],
            ],
            "Job Log": [
                ["Job", "Before photos?", "Wall type", "Services located?", "After photos?", "Referral asked?", "Notes"],
                ["Example single-bay", "Yes", "Plasterboard", "Yes", "Yes", "Yes", "Mounted into studs + toggle anchors"],
                ["", "", "", "", "", "", ""],
                ["", "", "", "", "", "", ""],
                ["", "", "", "", "", "", ""],
            ],
            "Proposal Copy": [
                ["Section", "Client-facing copy"],
                ["Scope", "I will install the agreed manufactured shelving, racks, and hooks, mounted level and into suitable fixings, and send before/after photos when done."],
                ["Boundary", "I install manufactured storage products. Structural changes, load-bearing modifications, heavy ceiling-mounted loads, and electrical or plumbing work are not included."],
                ["Approval", "You confirm wall type, what is being stored, any wiring/pipes, the layout, and the items to clear before work starts."],
                ["Not included", "Custom carpentry, repairs to existing walls, removal of fixed structures, and storage of contents beyond product weight ratings are not included unless scoped separately."],
            ],
        }
    if asset_id == "asset-headlight-pricing":
        return {
            "Instructions": [
                ["Step", "What to do"],
                [1, "Choose a package based on lens condition, car count, travel, weather window, and workspace access."],
                [2, "Use Quote Builder for one booking. Edit only the input values in column B."],
                [3, "Use Dealer Batch when 3+ restorable cars are at one location."],
                [4, "Keep pricing language honest: restoration may improve appearance and clarity, but does not guarantee like-new lights, compliance, or permanence."],
            ],
            "Pricing Ladder": [
                ["Package", "Deliverables", "Price", "Best For", "Notes"],
                ["Proof Car", "One permissioned car + before/after photos", 0, "Portfolio sample", "Use selectively, not as free labour"],
                ["Single-Car Pair", "Two plastic headlights restored + UV sealant", 119, "Most private owners", "Core offer"],
                ["One Headlight Only", "Single lens restoration", 79, "Partial damage or replacement mismatch", "Quote only when sensible"],
                ["Two-Car Household", "Two cars same address", 219, "Families and neighbours", "Shared setup and travel"],
                ["Used-Car Seller Prep", "Headlights + listing photo proof", 149, "Private sellers", "No sale-price claims"],
                ["Dealer Batch", "3+ cars at same site", 79, "Small dealers and fleets", "Per-car rate, restorable lenses only"],
            ],
            "Quote Builder": [
                ["Input", "Value"],
                ["Base single-car price", 119],
                ["Travel/setup fee", 25],
                ["Lens condition surcharge", 20],
                ["Extra cars at same address", 1],
                ["Price per extra car", 95],
                ["Dealer/fleet discount", 20],
                ["Materials cost per car", 12],
                ["Estimated quote", "=B2+B3+B4+(B5*B6)-B7"],
                ["Deposit due at 30%", "=B9*0.3"],
            ],
            "Dealer Batch": [
                ["Car Count", "Per-Car Rate", "Estimated Revenue", "Best Condition", "Notes"],
                [3, 89, "=A2*B2", "Light/moderate haze", "Half-morning slot"],
                [5, 79, "=A3*B3", "Mostly similar condition", "Needs shaded workspace"],
                [8, 69, "=A4*B4", "Quick batch candidates", "Reject cracked/moisture lenses"],
            ],
            "Job Profit Check": [
                ["Metric", "Illustrative Value", "Formula/Note"],
                ["Quote", "='Quote Builder'!B9", "From quote builder"],
                ["Materials", "='Quote Builder'!B8*(1+'Quote Builder'!B5)", "Use actual consumables"],
                ["Fuel/transport", 15, "Use actual"],
                ["Total hard cost", "=B3+B4", ""],
                ["Gross margin", "=B2-B5", ""],
                ["Job hours", 1.5, "Travel, masking, sanding, polish, sealant, handoff"],
                ["Hourly gross", "=IF(B7=0,\"\",B6/B7)", ""],
            ],
            "Client Inputs": [
                ["Input", "Owner", "Required?", "Status"],
                ["Car make/model/year", "Client", "Yes", "Open"],
                ["Photos of both headlights", "Client", "Yes", "Open"],
                ["Any cracks, moisture, previous restoration, or replacement history", "Client", "Yes", "Open"],
                ["Location and shaded workspace", "Client", "Yes", "Open"],
                ["Weather window and car access", "Client", "Yes", "Open"],
                ["Permission for before/after photos", "Client", "No", "Open"],
            ],
            "Job Log": [
                ["Job", "Before photos?", "Lens condition", "UV sealant?", "After photos?", "Referral asked?", "Limitations"],
                ["Example sedan", "Yes", "Moderate haze", "Yes", "Yes", "Yes", "Tiny internal mark remained"],
                ["", "", "", "", "", "", ""],
                ["", "", "", "", "", "", ""],
            ],
            "Proposal Copy": [
                ["Section", "Client-facing copy"],
                ["Scope", "I will restore the agreed plastic headlights using cleaning, masking, sanding, polishing, UV protection, and before/after photos."],
                ["Boundary", "Results depend on lens condition. Cracks, internal moisture, severe crazing, broken lenses, and electrical issues may require replacement or a qualified mechanic."],
                ["Approval", "You confirm lens photos, access, weather window, expectations, and whether I may use before/after photos."],
                ["Not included", "Roadworthy certification, legal compliance, permanent restoration, electrical work, bulb replacement, lens replacement, and paint repair are not included."],
            ],
        }
    if asset_id == "asset-shopify-pricing":
        return {
            "Instructions": [
                ["Step", "What to do"],
                [1, "Choose the package based on audit depth, number of priority products, email flow scope, and implementation support."],
                [2, "Use Quote Builder for one store. Edit only the input values in column B."],
                [3, "Use Profit Check before sending the quote so implementation work is not hidden inside the audit price."],
                [4, "Keep all client-facing pricing language illustrative and avoid guaranteed revenue, conversion, or ad-performance claims."],
            ],
            "Pricing Ladder": [
                ["Package", "Deliverables", "Price", "Best For", "Notes"],
                ["Mini Cart Teardown", "3 screenshot-backed fixes + 1 cart copy line", 149, "Cold outreach paid test", "No store access needed"],
                ["Starter Audit", "Mobile cart review + 5 fixes + 1 abandoned-cart email", 349, "Small stores testing demand", "48-hour delivery"],
                ["Full Cart Audit", "Product page, cart, checkout trust, policies, and 3-email sequence", 699, "Most founder-led stores", "Core offer"],
                ["Implementation Sprint", "Audit plus copy upload checklist and owner-approved changes", 1200, "Stores that need help applying fixes", "Requires access and approvals"],
                ["Monthly Cleanup", "New product checks, email refreshes, and friction reviews", 450, "Stores launching monthly", "Fixed monthly cadence"],
            ],
            "Quote Builder": [
                ["Input", "Value"],
                ["Base package price", 699],
                ["Priority products included", 3],
                ["Priority products requested", 5],
                ["Price per extra product", 75],
                ["Extra email count", 2],
                ["Price per extra email", 95],
                ["Implementation support fee", 250],
                ["Rush fee", 100],
                ["Estimated quote", "=B2+MAX(0,B4-B3)*B5+(B6*B7)+B8+B9"],
                ["Deposit due at 50%", "=B10*0.5"],
            ],
            "Scope Guardrails": [
                ["Scope Item", "Included?", "Notes"],
                ["Screenshot-backed audit", "Yes", "Use mobile first and mark exact friction points"],
                ["Abandoned-cart copy", "Yes", "Client approves timing, discounts, policy claims, and compliance"],
                ["Theme redesign", "No", "Refer or quote separately"],
                ["Paid ad management", "No", "Out of scope"],
                ["Revenue guarantee", "No", "Never promise conversion, revenue, or ROAS lift"],
                ["Implementation", "Only if priced", "Separate from audit unless quoted"],
            ],
            "Profit Check": [
                ["Metric", "Illustrative Value", "Formula/Note"],
                ["Quote", "='Quote Builder'!B10", "From quote builder"],
                ["Research hours", 2, "Store review and screenshots"],
                ["Copywriting hours", 2, "Cart copy and email copy"],
                ["Implementation hours", 0, "Only if included"],
                ["Total hours", "=B3+B4+B5", ""],
            ...
            "Client Inputs": [
                ["Input", "Owner", "Required?", "Status"],
                ["Store URL and priority products", "Client", "Yes", "Open"],
                ["Shipping, returns, warranty, and delivery policies", "Client", "Yes", "Open"],
                ["Email platform and current abandoned-cart timing", "Client", "No", "Open"],
                ["Approved discounts, testimonials, and product claims", "Client", "Yes", "Open"],
                ["Brand voice examples and forbidden claims", "Client", "No", "Open"],
                ["Implementation owner and access rules", "Client", "If implementation is included", "Open"],
            ],
            "Proposal Copy": [
                ["Section", "Client-facing copy"],
                ["Scope", "I will review the mobile buying path and deliver screenshot-backed fixes, buyer-confidence copy, and abandoned-cart email recommendations."],
    ...
    if asset_id == "asset-gym-pricing":
        return {
            "Instructions": [
                ["Step", "What to do"],
                [1, "Choose the package based on data cleanliness, number of cancellation records, membership types, and whether a review call is included."],
                [2, "Use Quote Builder for one studio. Edit only the input values in column B."],
                [3, "Use Data Scope to keep anonymized starter work separate from deeper retention consulting."],
                [4, "Avoid promising lower churn, saved revenue, or guaranteed member retention."],
            ],
            "Pricing Ladder": [
                ["Package", "Deliverables", "Price", "Best For", "Notes"],
                ["Dummy Sample Snapshot", "Sample report with realistic dummy data", 0, "Cold outreach proof", "No private data"],
                ["One-Month Churn Snapshot", "Anonymized cancellation tag report + 3 actions", 350, "First paid test", "Owner supplies export"],
                ["Retention Review Sprint", "Report + revenue-at-risk view + save-script ideas + 30-min call", 850, "Studios with active churn pain", "Core offer"],
                ["Monthly Retention Report", "Monthly trend report + action follow-up + agenda", 900, "Retainer", "Fixed cadence"],
                ["Multi-Location Add-On", "Extra location or studio segment", 250, "Small groups", "Per location/month"],
            ],
            "Quote Builder": [
                ["Input", "Value"],
                ["Base package price", 850],
                ["Cancellation records included", 100],
                ["Cancellation records requested", 150],
                ["Price per extra 25 records", 75],
                ["Membership types included", 3],
                ["Extra membership types requested", 2],
                ["Price per extra membership type", 60],
                ["Review call fee", 150],
                ["Rush fee", 100],
                ["Estimated quote", "=B2+MAX(0,ROUNDUP((B4-B3)/25,0))*B5+MAX(0,B7)*B8+B9+B10"],
                ["Deposit due at 50%", "=B11*0.5"],
            ],
            "Data Scope": [
                ["Scope Item", "Included?", "Notes"],
                ["Anonymized cancellation reasons", "Yes", "Preferred for starter work"],
                ["Membership type tags", "Yes", "Useful for segmented recommendations"],
                ["Attendance notes", "Optional", "Only if owner can export safely"],
                ["Raw member names/contact details", "No", "Do not request for starter work"],
                ["Health, injury, or sensitive personal details", "No", "Use broad tags only"],
                ["Guaranteed churn reduction", "No", "Never promise retention outcomes"],
            ],
            "Profit Check": [
                ["Metric", "Illustrative Value", "Formula/Note"],
                ["Quote", "='Quote Builder'!B11", "From quote builder"],
                ["Data cleanup hours", 2, "Export cleanup and tagging"],
                ["Analysis hours", 2, "Theme review and action plan"],
                ["Owner call hours", 1, "Review call plus notes"],
                ["Total hours", "=B3+B4+B5", ""],
                ["Software/tools", 20, "Use actual costs"],
                ["Gross before time", "=B2-B7", ""],
                ["Hourly gross", "=IF(B6=0,\"\",B8/B6)", ""],
            ...
            "Proposal Copy": [
                ["Section", "Client-facing copy"],
                ["Scope", "I will turn one month of anonymized cancellation notes into a short churn snapshot with reason tags, themes, revenue-at-risk placeholders, and three owner-approved actions."],

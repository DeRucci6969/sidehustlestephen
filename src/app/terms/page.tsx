...
export const metadata = {
  title: "Terms | Side Hustle Stephen - The Launchpad",
};
  ...
  const sections = [
    {
      ...
      body: [
        "By accessing The Launchpad, creating an account, purchasing a subscription, downloading an asset, or otherwise using this website, you agree to these Terms of Use and any policies linked from this website, including our Privacy Policy.",
        "If you do not agree, do not use the website, purchase a subscription, download assets, or rely on any material provided through The Launchpad.",
      ],
    },
    {
      title: "2. Educational information only",
      body: [
        "The Launchpad provides educational business ideas, examples, templates, worksheets, prompts, scripts, calculators, playbooks, and related resources. The content is general information only. It is not legal, financial, accounting, tax, investment, employment, regulatory, insurance, professional, or other specialist advice.",
    ...
    },
    {
      ...
      body: [
        "The Launchpad is not selling a franchise, distributorship, agency, employment opportunity, investment, managed business, partnership, joint venture, or guaranteed business opportunity. Nothing on this website creates an employment, contractor, agency, partnership, fiduciary, or joint venture relationship between you and us.",
    ...
    },
    {
      ...
      body: [
        ...
        "You must not use The Launchpad to make false, misleading, deceptive, unsubstantiated, unlawful, discriminatory, harassing, spammy, infringing, or harmful claims or communications.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "You may adapt templates and scripts for use in your own business with your own clients, but you may not sell The Launchpad assets themselves as standalone products or imply that we endorse, certify, supervise, or are responsible for your services.",
      ],
    },
    {
      ...
      body: [
        ...
        "Except for the limited license expressly granted in these terms, no rights are transferred to you. You must not copy, reverse engineer, reproduce, modify, distribute, create derivative products from, or commercially exploit any part of The Launchpad except as expressly allowed.",
      ],
    },
    {
      title: "9. Accounts, access, and security",
      body: [
        "You are responsible for maintaining the confidentiality and security of your account, email access, login links, devices, and any credentials used to access The Launchpad. You are responsible for activity under your account.",
    ...
    },
    {
      ...
      body: [
        "The Launchpad may link to, reference, or integrate with third-party services such as payment processors, authentication providers, AI tools, design tools, analytics tools, email tools, file services, social platforms, or external websites.",
    ...
    },
    {
      ...
      body: [
        "You must not use The Launchpad to break the law, infringe rights, harass others, send spam, scrape or harvest data, bypass access controls, attack the website, introduce malware, interfere with service operation, share paid access, misrepresent your relationship with us, or use assets in a way that could harm us, users, clients, consumers, or the public.",
    ...
    },
    {
      ...
      body: [
        "The website and assets are provided on an as-available basis. We may modify, replace, remove, suspend, discontinue, restrict, or update any part of The Launchpad at any time, including packs, assets, prices, features, account flows, and download links.",
    ...
    },
    {
      ...
      body: [
        "To the maximum extent permitted by law, The Launchpad and all content, assets, templates, prompts, examples, downloads, and services are provided as is and as available, without warranties of any kind, whether express, implied, statutory, or otherwise.",
    ...
    },
    {
      ...
      body: [
        "To the maximum extent permitted by law, we are not liable for any indirect, incidental, special, consequential, exemplary, punitive, or economic loss; loss of profit, revenue, savings, goodwill, data, clients, business opportunity, reputation, or anticipated benefit; or any claim arising from your use of, reliance on, or inability to use The Launchpad.",
        "To the maximum extent permitted by law, our total aggregate liability for all claims connected with The Launchpad is limited to the amount you paid us for The Launchpad in the three months before the event giving rise to the claim, or AUD $100 if you have not paid us anything.",
    ...
    },
    {
      ...
      body: [
        ...
        "Before starting formal proceedings, you agree to contact us and try to resolve the dispute in good faith. Subject to any non-excludable legal rights, the courts of New South Wales, Australia will have jurisdiction over disputes connected with these terms or The Launchpad.",
      ],
    },
    {
      title: "20. Changes to these terms",
      body: [
        "We may update these terms from time to time. The updated version will apply from the date it is posted or from any later date stated on the page. Your continued use of The Launchpad after changes are posted means you accept the updated terms.",
      ],
    },
    {
      title: "21. Contact",
      body: [
        "Questions about these terms should be sent through the contact method provided on the website or by replying to official account emails from The Launchpad.",
      ],
    },
  ];
      ...
      <main className="mx-auto min-h-[70vh] w-full max-w-5xl px-4 py-12 sm:px-8">
        <article className="glass rounded-[2rem] p-6 sm:p-8 lg:p-10">
          ...
          <div className="mt-6 rounded-[1.5rem] bg-white/58 p-4 text-sm leading-7 text-[var(--graphite)] ring-1 ring-white/70 sm:p-5">
            <p>
              These terms are a protective website template for The Launchpad and should be reviewed by a qualified lawyer before public launch or live payments. They are drafted to operate only to the maximum extent permitted by applicable law.
            </p>
          </div>

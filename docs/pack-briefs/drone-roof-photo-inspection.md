...
- **Reel:** `Business Pack Website/launchpad-videos/renders/drone-roof-inspection-REEL-v2.mp4` (96.3s, 9:16). Structure: avatar intro → Glacier-Glass middle → avatar transition → launch-pack CTA.
- **Composition source:** `launchpad-videos/drone-build/` (`index.html`, `assets/audio/vo.mp3`, aerial b-roll in `assets/broll/`).
